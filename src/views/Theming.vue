    ...
    <div id="theming-content">
      <div id="color-theming">
        ...
        <div id="color-picking">
          ...
          <div>
            <label for="picking-hex">Hex : <input id="picking-hex" v-model="color" maxlength="7" @keypress="filterHex"
                v-italic /></label>
          </div>
          <div id="rgb">
      ...
      <div id="background-theming">
        ...
        <div id="random-check">
          <LCheckbox v-model="settings.randomizeBG" /><span class="background-label" v-italic>{{ randomizeLabel }}</span>
        </div>
      </div>
    </div>
