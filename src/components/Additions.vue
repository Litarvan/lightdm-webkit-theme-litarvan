	...
	<div id="additions" :class="{ small: small }">
		...
		>
			<img
				...
				class="addition-icon"
				:src="
					require('../assets/images/battery/' + batteryIcon + '.svg')
				"
			/>
			<img
			...
			/>
			<span id="battery-value"> {{ batteryValue }}% </span>
		</div>
		...
		>
			<img
				...
				class="addition-icon"
				:src="
					require('../assets/images/brightness/' +
						brightnessIcon +
						'.svg')
				"
			/>
			...
			<span id="brightness-value"> {{ brightnessValue }}% </span>
		</div>
	</div>
</template>
