const translations = {
    ...
    'ru': {
        ...
        setup: 'Настройка',
        theming: 'Оформление',
        disableSplash: 'Выключить приветствие (Экран "Нажмите ввод")',
        disableSplashText: 'Убрать приветственный текст (только часы)',
        disableIntro: 'Выключить предзагрузку лого',
        disableFade: 'Не затемнять экран после входа',
        roundAvatar: 'Скругленный аватар',
        disableAvatar: 'Выключить аватар',
        disableZoom: 'Выключить увеличение Х2 (для больших экранов)',
        clock12: '12-часовой формат',
        disablePowerTexts: 'Выключить экран статуса (перезагрузка и т.д.)',
        blurSettings: 'Настройки размытия',
        capsLock: 'Caps lock Включен',

        primaryColor: 'Основной цвет',
        randomizeBG: 'Выбирать рандомно',
        bgAdd: 'Фоны могут быть добавлены в',

        blur: 'Размытие',
        fixedBlur: 'Размытый фиксированный фон',
