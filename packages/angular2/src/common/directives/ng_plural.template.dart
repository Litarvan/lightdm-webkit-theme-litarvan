...
const <dynamic>[const Deprecated('Copy into your own project if needed, no longer supported')],
const [const <dynamic>[String, const Attribute("ngPluralCase")], const <dynamic>[TemplateRef], const <dynamic>[ViewContainerRef]],
...
const <dynamic>[const Deprecated('Copy into your own project if needed, no longer supported')],
const [const <dynamic>[NgLocalization]],
